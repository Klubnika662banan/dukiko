function t_skiplink__addButton() {
 ...
 function t_skiplink__addAnchor() {
    ...
    if (t && t.insertAdjacentHTML("afterend", n), 0 < e.length && !t) {
       t = e[0].parentNode;
       if (1 === e.length) t.insertAdjacentHTML("afterend", n);
       else
          for (var i = 0; i < e.length; i++) {
             var r = e[i].parentNode;
             if (null === r.nextSibling.querySelector('[data-menu="yes"]')) return void r.insertAdjacentHTML("afterend", n)
          }
    }
 }
