window = window || {},
   function () {
      function e() {
         ...
         try {
            var a = document.getElementById("allrecords"),
               i = a ? a.getAttribute("data--cookie") : null;
            a && "no" === i || saveUTM()
         } catch (e) {}
         ...
         function d(e) {
            ...
            if (e.target && t) {
               var r = t.getAttribute("data--event-name"),
                  a = t.textContent,
               ...
               if (!r) {
                  var d = t.closest(".r"),
                     c;
                  r = "//click/" + (d ? d.getAttribute("id") : "") + "/?url=" + i
               }
               if (sendEventToStatistics(r, a), "http" === i.substring(0, 4) && -1 === i.indexOf(".typeform.com/")) return window.setTimeout((function () {
                  var e = "",
                     t = "";
                  if ("_blank" === o) {
                     if (-1 !== i.indexOf("?") && (e = i.split("?"), i = e[0], -1 !== (e = e[1]).indexOf("#") && (e = e.split("#"), i = i + "#" + e[1], e = e[0]), e = e.split("&")), document.getElementById("redirectform") ? (document.getElementById("redirectform").setAttribute("method", "GET"), document.getElementById("redirectform").setAttribute("action", i)) : document.body.insertAdjacentHTML("beforeend", '<form id="redirectform" target="_blank" method="GET" action="' + i + '" style="display:none;"></form>'), t = "", e.length > 0)
                        for (var r in e) {
                           var a = e[r].indexOf("=");
                           if (a > -1) {
                     ...
                     if ("" === t) window.open(i, "_blank");
                        ...
                        var n = document.getElementById("redirectform");
      ...
      sendEcommerceEvent = function (e, t) {
         ...
         var p;
         "add" !== e && "remove" !== e || (r = "//cart/" + e + "/", n > 0 && (r += "" + n), m > 0 ? r += "-u" + m : l > 0 && (r += "-" + l)), "detail" === e && (r = "//product/detail/", m > 0 ? r += m + "/" : (n > 0 && (r += "r" + n), l > 0 && (r += "-l" + l))), "purchase" === e && (r = "//rec" + n + "/payment/"), (p = {
            ecommerce: {}
         }).ecommerce[e] = {
            products: o
         }, sendEventToStatistics(r, a, p, i)
      }, sendEventToStatistics = function (e, t, r, a) {
         var i = "/" === e.substring(0, 1),
            o = [],
            d, c;
         (d = document.getElementById("allrecords")) && (c = null !== d.getAttribute("data-fb-event") ? d.getAttribute("data-fb-event") : window.jQuery && void 0 !== $("#allrecords").data("fb-event") ? $("#allrecords").data("fb-event") : null);
         var n = !(!c || "nosend" !== c),
         ...
         if (u = d.getAttribute("data--currency") ? d.getAttribute("data--currency") : p && p.getAttribute("data-project-currency-code") ? p.getAttribute("data-project-currency-code") : "RUB", r || (r = window.location.href), (a = a ? parseFloat(a) : 0) > 0)
            if (window.dataLayer || (window.dataLayer = []), -1 !== e.indexOf("//") && -1 !== e.indexOf("/payment/") && window.Form && window.Form.orderIdForStat > "") r = {
               ecommerce: {
                  purchase: {
                     actionField: {
                        id: window.Form.orderIdForStat,
                        revenue: window.Form.amountForStat
                     },
                     products: window.Form.arProductsForStat
                  }
               }
            }, window.Form.payment && window.Form.payment.promocode && (r.ecommerce.purchase.actionField.coupon = window.Form.payment.promocode), r.event = "purchase";
         ...
         if (window.ga && "" !== window.mainTracker && "gtag" !== window.mainTracker)
            if (i)
               if (r && r.event) {
                  try {
                     if (window.isLoadGAEcommerce || (window.isLoadGAEcommerce = !0, ga("require", "ec")), ga("set", "currencyCode", u), "purchase" === r.event) {
         ...
         if (window.mainMetrika > "" && window[window.mainMetrika] && (i ? a > 0 ? window[window.mainMetrika].hit(e, {
            ...
            if (i)
               if (-1 === e.indexOf("/") || -1 === e.indexOf("/payment/") && -1 === e.indexOf("/submitted/"))
                  if (r && r.event && a > 0)
            ...
            } else e.indexOf("/popup"), window.fbq("track", "ViewContent", {
               content_name: t,
               content_category: e
            });
            else e.indexOf("/popup"), window.fbq("track", "ViewContent", {
         ...
         if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && !1 === l) try {
            if (i) {
               ...
               else if (-1 !== e.indexOf("/") && -1 !== e.indexOf("/payment/")) T = "t-purchase-" + (E = (E = (E = e.replace("//", "")).replace("/", "")).replace("/payment/", ""));
               else if (-1 !== e.indexOf("/") && -1 !== e.indexOf("/submitted/")) T = "t-lead-" + (E = (E = (E = e.replace("//", "")).replace("/", "")).replace("/submitted/", ""));
               else if (-1 !== e.indexOf("/popup")) T = "t-" + (E = (E = e.replace("//", "")).replace("/", "-"));
               else if (-1 !== e.indexOf("/click")) T = "t-" + (E = (E = e.replace("//", "")).replace("/", "-"));
         ...
         "function" == typeof window.stat && (i ? (e.indexOf("payment") > 0 && e.indexOf("/form") > -1 && (e = e.replace("/form", "/rec")), window.stat("pageview", {
            page: e
         })) : window.stat("pageview", {
            page: "//event/" + e
         }))
      }, saveUTM = function () {
         try {
            ...
            if (-1 !== e.toLowerCase().indexOf("utm_") && "string" == typeof (t = (t = (e = e.toLowerCase()).split("?"))[1])) {
               ...
               if (r.length > 0) {
                  var d = new Date;
                  d.setDate(d.getDate() + 30), document.cookie = "UTM=" + encodeURIComponent(r) + "; path=/; expires=" + d.toUTCString()
               }
            }
         } catch (e) {}
