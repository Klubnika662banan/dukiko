function t_menu__highlightActiveLinks(e) {
    ...
    Array.prototype.forEach.call(i, (function (e) {
       ...
       if (i) {
          var o = e.href;
          o !== t && o !== r && i !== t && i !== r && n !== t && n !== r || e.classList.add("t-active")
       }
    }))
 }
    ...
    if (!(window.innerWidth <= 980) || r) {
       ...
       Array.prototype.forEach.call(o, (function (e) {
          var t = e.getAttribute("data-bgcolor-rgba"),
             ...
             o = e.getAttribute("data-menushadow") || "0",
             a = "100" === o ? o : "0." + o;
          e.style.backgroundColor = window.pageYOffset > 20 ? n : t, window.pageYOffset > 20 && "0" === i || window.pageYOffset <= 20 && "0.0" === r || " " === o ? e.style.boxShadow = "none" : e.style.boxShadow = "0px 1px 3px rgba(0,0,0," + a + ")"
       }))
    }
 }
 ...
 function t_menu__createMobileMenu(e, t) {
    ...
    if (n) {
       ...
       if (a)
          if (r && r.classList.contains(t.slice(1) + "__mobile_burgerhook") && i) {
             ...
             a.addEventListener("click", (function (n) {
                if (!n.target.closest("a")) {
                   if (a.classList.contains(l)) t_menu__FadeOut(r, 300), a.classList.remove(l), u.classList.remove(s);
                   else if (t_menu__fadeIn(r, 300, (function () {
                         r.style.transform && (r.style.transform = ""), r.style.opacity && (r.style.opacity = "")
                      })), a.classList.add(l), u.classList.add(s), r.classList.contains("tmenu-mobile__menucontent_fixed")) {
          ...
          } window.innerWidth < 980 && n.addEventListener("click", (function (n) {
          if (r && r.classList.contains("tmenu-mobile__menucontent_fixed")) {
             var i = n.target.closest(".t-menu__link-item, .t978__submenu-link, .t966__menu-link, .t-menusub__link-item, .t-btn"),
                o, c;
 ...
 function t_menu__interactFromKeyboard(e) {
    ...
    if (t) {
       var n = t.querySelectorAll('[role="menubar"] > li > a'),
          r = t.querySelectorAll('[role="menubar"]  > li li'),
          i = 9,
          o = 13,
          a = 27,
          l = 32,
          ...
          f = 0,
          m, _ = function (e) {
             e === n.length ? e = 0 : e < 0 && (e = n.length - 1), n[e].focus(), f = e
          },
          p = function (e, t) {
             var n = e.querySelectorAll("a");
             t == n.length ? t = 0 : t < 0 && (t = n.length - 1), n[t].focus(), m = t
          },
          y = function (e) {
             e.addEventListener("keydown", (function (t) {
                var r = this.parentNode.querySelector(".t-menusub__list");
                switch (t.keyCode) {
                   case c:
                      _(f + 1);
                      break;
                   case s:
                      ...
                      break;
                   case i:
                      if (!t.shiftKey && f <= n.length - 2) _(f + 1);
                      else {
                         if (!(t.shiftKey && f > 0)) return void e.setAttribute("tabindex", "0");
                         _(f - 1)
                      }
                      break;
                   case o:
                   ...
                   case l:
                      if (!r) return;
                      this.click(), m = 0, p(r, 0);
                      break;
                   case u:
                      if (!r) return;
                      this.click(), m = r.querySelectorAll("li").length - 1, p(r, m)
                }
                t.preventDefault()
             }))
          },
          b = function (e) {
             e.addEventListener("focus", (function () {
                m = 0, Array.prototype.forEach.call(n, (function (e) {
                   e.hasAttribute("aria-haspopup") && e.setAttribute("aria-expanded", "false")
                })), 0 !== f && 0 === Number(this.getAttribute("tabindex")) && this.setAttribute("tabindex", -1)
             }))
          },
          h = function (e) {
             var t = e.parentNode.querySelector(".t-menusub__menu");
             e.addEventListener("click", (function (n) {
                if ("true" !== this.getAttribute("aria-haspopup") || "false" != this.getAttribute("aria-expanded") && null != this.getAttribute("aria-expanded")) this.setAttribute("aria-expanded", "false");
                else {
          ...
          g = function (e) {
             ...
             e.addEventListener("keydown", (function (e) {
                ...
                switch (e.keyCode) {
                   case i:
                      r = !0;
                      var b = y.querySelectorAll(".t-menusub__link-item").length;
                      if (e.shiftKey) 0 === m ? (_(f), t_menusub__hideSubmenu(t)) : p(y, m - 1);
                      else if (m === b - 1) {
                         if (t_menusub__hideSubmenu(t), f === n.length - 1) return void n[f].setAttribute("tabindex", "0");
                         _(f + 1)
                      } else p(y, m + 1);
                      break;
                   case c:
                      r = !0, _(f + 1), t_menusub__hideSubmenu(t);
                      break;
                   case s:
                      r = !0, _(f - 1), t_menusub__hideSubmenu(t);
                      break;
                   ...
                   case l:
                      ...
                      break;
                   case a:
                      r = !0, _(f), t_menusub__hideSubmenu(t);
                      break;
                   case d:
                      r = !0, p(y, m + 1);
                      break;
       ...
       Array.prototype.forEach.call(n, (function (e, t) {
          var n;
          0 == t ? e.setAttribute("tabindex", "0") : e.setAttribute("tabindex", "-1"), b(e), y(e), e.parentNode.querySelector(".t-menusub__menu") && !window.isMobile && h(e)
       })), Array.prototype.forEach.call(r, (function (e) {
          e.setAttribute("tabindex", "-1"), g(e)
       }))
    }
 }
