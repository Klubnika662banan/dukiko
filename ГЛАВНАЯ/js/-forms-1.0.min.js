...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.Form = {
   versionLib: "02.001",
   endpoint: "forms.cdn.com",
   isRecaptchaScriptInit: !1,
   currentFormProccessing: !1
}, t_forms__onReady(function () {
   var t = document.getElementById("allrecords");
   !t || (r = t.getAttribute("data--project-lang")) && (window.t_forms__lang = r), t_forms__initForms();
   ...
   (e || t || r) && (o = "-forms-payments-1.0", document.head.querySelector('script[src*="' + o + '"]') || ((a = document.createElement("script")).type = "text/javascript", a.src = "https://static.cdn.com/js/" + o + ".min.js", a.onerror = function () {
      console.error("Failed to load -forms-payments: ", this.src)
   }, document.head.appendChild(a)));
   var o, a, r = window.t_forms__lang;
   "RU" !== r && "EN" !== r && (o = "-forms-dict-1.0", document.head.querySelector('script[src*="' + o + '"]') || ((a = document.createElement("script")).type = "text/javascript", a.src = "https://static.cdn.com/js/" + o + ".min.js", a.onerror = function () {
      console.error("Failed to load -forms-dictionary: ", this.src)
   }, document.head.appendChild(a)))
}), window.Form.captchaCallback = function () {
   if (!window.Form.currentFormProccessing || !window.Form.currentFormProccessing.form) return !1;
   window.Form.send(window.Form.currentFormProccessing.form, window.Form.currentFormProccessing.btn, window.Form.currentFormProccessing.formtype, window.Form.currentFormProccessing.formskey), window.Form.currentFormProccessing = !1
}, window.Form_customMasksLoad = function () {
   var t;
   !0 !== window.isInitEventsCustomMask && ((t = document.createElement("script")).type = "text/javascript", t.src = "https://static.cdn.com/js/-forms-custommask-1.0.min.js", document.head.appendChild(t), window.isInitEventsCustomMask = !0)
}, window.Form_initMasks = function () {
   var t = document.querySelectorAll(".js--mask");
   if (t.length && !0 !== window.isInitEventsCustomMask) return window.Form_customMasksLoad(), void window.setTimeout(function () {
      window.Form_initMasks()
   }, 100);
   ...
   window.Form_initMasks()
}), window.Form.validate = function (t) {
   t instanceof Element || (t = t[0]);
   for (var e, r, o = t.querySelectorAll(".js--rule"), a = [], n = !0, i = 0; i < o.length; i++) {
      var s = o[i],
         l = !!parseInt(s.getAttribute("data--req") || 0, 10),
         d = s.getAttribute("data--rule") || "none",
         c = "",
         u = "",
         m = s.getAttribute("data--rule-minlength") || 0,
         p = s.getAttribute("data--rule-maxlength") || 0,
         f = {},
         _ = s.value,
         y = "",
      ...
      if (l && (b || w && h)) f.type.push("req");
         ...
         switch (d) {
            ...
            case "url":
               ...
               break;
            case "phone":
               var v = s.getAttribute("data--mask"),
                  E = "^[0-9()+-";
            ...
            case "date":
               ...
               } [s.getAttribute("data--dateformat")] || /^[0-9]{1,4}[\-\.\/][0-9]{1,2}[\-\.\/][0-9]{1,4}$/gi) && f.type.push("date");
               break;
            case "time":
...
}, window.Form.showErrorInPopup = function (t, e) {
   ...
   var r, o = t.getAttribute("id"),
      ...
      l = "",
      d = "",
      c = document.getElementById("-popup-for-error");
   c || (document.body.insertAdjacentHTML("beforeend", '<div id="-popup-for-error" class="js-form-popup-errorbox tn-form__errorbox-popup" style="display: none;"> <div class="t-form__errorbox-text t-text t-text_xs"> error </div> <div class="tn-form__errorbox-close js-errorbox-close"> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-left"></div> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-right"></div> </div> </div>'), t_addEventListener(c = document.getElementById("-popup-for-error"), "click", function (t) {
   ...
   }, 1e4), window.isInitEventsZB[o] || (u = t.closest(".r"), m = "focus", document.addEventListener || (m = "focusin"), t_removeEventListener(u, m, h), t_addEventListener(u, m, h, !0), t_removeEventListener(u, "change", h), t_addEventListener(u, "change", h, !0)), t_triggerEvent(t, "form:aftererror"), !0
}, window.Form.showErrors = function (t, e) {
   if (t instanceof Element || (t = t[0]), !e || !e.length) return !1;
   if ("y" === t.getAttribute("data-error-popup")) return Form.showErrorInPopup(t, e);
   ...
   return Array.prototype.forEach.call(p, function (t) {
      t.style.display = "block"
   }), t_triggerEvent(t, "form:aftererror"), !0
}, window.Form.addCaptcha = function (t, e) {
   t instanceof Element || (t = t[0]);
   var r, o = document.getElementById("formcaptchabox"),
      a = document.getElementById("js-spec-captcha");
   o && t_removeEl(o), a && t_removeEl(a), t.insertAdjacentHTML("beforeend", '<input type="hidden" name="spec-captcha" id="js-spec-captcha">');
   try {
      r = (new Date).getTime() + "=" + parseInt(8 * Math.random(), 10)
   } catch (t) {
      r = "rnd=" + parseInt(8 * Math.random(), 10)
   }
   e = '<div id="formcaptchabox" style="z-index: 99999999999; position:fixed; text-align: center; vertical-align: middle; top: 0px; left:0px; bottom: 0px; right: 0px; background: rgba(255,255,255,0.97);"><iframe id="captchaIframeBox" src="//' + window.Form.endpoint + "/procces/captcha/?spec-formid=" + t.getAttribute("id") + "&spec-formskey=" + e + "&" + r + '" frameborder="0" width="100%" height="100%"></iframe></div>';
   document.body.insertAdjacentHTML("beforeend", e), window.removeEventListener("message", checkVerifyCaptcha), window.addEventListener("message", checkVerifyCaptcha)
}, window.Form.addMebersInfoToForm = function (t) {
   t instanceof Element || (t = t[0]);
   try {
      window.Form.member = {};
      var e = t.querySelector(".js--mauserinfo");
      if (e && t_removeEl(e), !window.mauser || !window.mauser.code || !window.mauser.email) return !1;
      window.mauser.name && (window.Form.member.name = window.mauser.name), window.Form.member.email = window.mauser.email, window.Form.member.code = window.mauser.code
   } catch (t) {
      return console.log("addMebersInfoToForm exception: ", t), !1
   }
   return !0
}, window.Form.closeSuccessPopup = function () {
   var t = document.getElementById("formsuccesspopup");
   t && (t_removeClass(document.body, "t-body_success-popup-showed"), /iPhone|iPad|iPod/i.test(navigator.userAgent) && !window.MSStream && window.Form.unlockBodyScroll(), t_fadeOut(t))
}, window.Form.lockBodyScroll = function () {
...
}, window.Form.unlockBodyScroll = function () {
   var t, e = document.body;
...
}, window.Form.showSuccessPopup = function (t) {
   var e = "",
      r = document.getElementById("formsuccesspopup"),
      o = document.getElementById("formsuccesspopuptext"),
      a = document.body;
   r || (e += '<style media="screen"> .t-form-success-popup { display: none; position: fixed; background-color: rgba(0,0,0,.8); top: 0px; left: 0px; width: 100%; height: 100%; z-index: 10000; overflow-y: auto; cursor: pointer; } .t-body_success-popup-showed { height: 100vh; min-height: 100vh; overflow: hidden; } .t-form-success-popup__window { width: 100%; max-width: 400px; position: absolute; top: 50%; -webkit-transform: translateY(-50%); transform: translateY(-50%); left: 0px; right: 0px; margin: 0 auto; padding: 20px; box-sizing: border-box; } .t-form-success-popup__wrapper { background-color: #fff; padding: 40px 40px 50px; box-sizing: border-box; border-radius: 5px; text-align: center; position: relative; cursor: default; } .t-form-success-popup__text { padding-top: 20px; } .t-form-success-popup__close-icon { position: absolute; top: 14px; right: 14px; cursor: pointer; } @media screen and (max-width: 480px) { .t-form-success-popup__text { padding-top: 10px; } .t-form-success-popup__wrapper { padding-left: 20px; padding-right: 20px; } } </style>', e += '<div class="t-form-success-popup" style="display:none;" id="formsuccesspopup"> <div class="t-form-success-popup__window"> <div class="t-form-success-popup__wrapper"> <svg class="t-form-success-popup__close-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" class="t657__icon-close" viewBox="0 0 23 23"> <g fill-rule="evenodd"> <path d="M0 1.41L1.4 0l21.22 21.21-1.41 1.42z"/> <path d="M21.21 0l1.42 1.4L1.4 22.63 0 21.21z"/> </g> </svg> <svg width="50" height="50" fill="#62C584"> <path d="M25.1 49.28A24.64 24.64 0 0 1 .5 24.68 24.64 24.64 0 0 1 25.1.07a24.64 24.64 0 0 1 24.6 24.6 24.64 24.64 0 0 1-24.6 24.61zm0-47.45A22.87 22.87 0 0 0 2.26 24.68 22.87 22.87 0 0 0 25.1 47.52a22.87 22.87 0 0 0 22.84-22.84A22.87 22.87 0 0 0 25.1 1.83z"/> <path d="M22.84 30.53l-4.44-4.45a.88.88 0 1 1 1.24-1.24l3.2 3.2 8.89-8.9a.88.88 0 1 1 1.25 1.26L22.84 30.53z"/> </svg> <div class="t-form-success-popup__text t-descr t-descr_sm" id="formsuccesspopuptext"> Thank You! </div> </div> </div> </div>', a.insertAdjacentHTML("beforeend", '<style media="screen"> .t-form-success-popup { display: none; position: fixed; background-color: rgba(0,0,0,.8); top: 0px; left: 0px; width: 100%; height: 100%; z-index: 10000; overflow-y: auto; cursor: pointer; } .t-body_success-popup-showed { height: 100vh; min-height: 100vh; overflow: hidden; } .t-form-success-popup__window { width: 100%; max-width: 400px; position: absolute; top: 50%; -webkit-transform: translateY(-50%); transform: translateY(-50%); left: 0px; right: 0px; margin: 0 auto; padding: 20px; box-sizing: border-box; } .t-form-success-popup__wrapper { background-color: #fff; padding: 40px 40px 50px; box-sizing: border-box; border-radius: 5px; text-align: center; position: relative; cursor: default; } .t-form-success-popup__text { padding-top: 20px; } .t-form-success-popup__close-icon { position: absolute; top: 14px; right: 14px; cursor: pointer; } @media screen and (max-width: 480px) { .t-form-success-popup__text { padding-top: 10px; } .t-form-success-popup__wrapper { padding-left: 20px; padding-right: 20px; } } </style><div class="t-form-success-popup" style="display:none;" id="formsuccesspopup"> <div class="t-form-success-popup__window"> <div class="t-form-success-popup__wrapper"> <svg class="t-form-success-popup__close-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" class="t657__icon-close" viewBox="0 0 23 23"> <g fill-rule="evenodd"> <path d="M0 1.41L1.4 0l21.22 21.21-1.41 1.42z"/> <path d="M21.21 0l1.42 1.4L1.4 22.63 0 21.21z"/> </g> </svg> <svg width="50" height="50" fill="#62C584"> <path d="M25.1 49.28A24.64 24.64 0 0 1 .5 24.68 24.64 24.64 0 0 1 25.1.07a24.64 24.64 0 0 1 24.6 24.6 24.64 24.64 0 0 1-24.6 24.61zm0-47.45A22.87 22.87 0 0 0 2.26 24.68 22.87 22.87 0 0 0 25.1 47.52a22.87 22.87 0 0 0 22.84-22.84A22.87 22.87 0 0 0 25.1 1.83z"/> <path d="M22.84 30.53l-4.44-4.45a.88.88 0 1 1 1.24-1.24l3.2 3.2 8.89-8.9a.88.88 0 1 1 1.25 1.26L22.84 30.53z"/> </svg> <div class="t-form-success-popup__text t-descr t-descr_sm" id="formsuccesspopuptext"> Thank You! </div> </div> </div> </div>'), r = document.getElementById("formsuccesspopup"), o = document.getElementById("formsuccesspopuptext"), e = r.querySelector(".t-form-success-popup__close-icon"), t_addEventListener(r, "click", function (t) {
      ((t = t || window.event).target || t.srcElement) === this && window.Form.closeSuccessPopup()
   }), t_addEventListener(e, "click", function () {
      window.Form.closeSuccessPopup()
   }), t_addEventListener(a, "keydown", function (t) {
      27 == ((t = t || window.event).keyCode || t.which) && window.Form.closeSuccessPopup()
      ...
      window.Form.lockBodyScroll()
   }, 500)
}, window.Form.successEnd = function (form, successUrl, successCallback) {
   form instanceof Element || (form = form[0]);
   var successBox = form.querySelector(".js-successbox"),
      successStr = t_forms__getMsg("success"),
      dataSuccessMessage;
   successBox && (dataSuccessMessage = successBox.getAttribute("data-success-message"), dataSuccessMessage ? successBox.innerHTML = dataSuccessMessage : successBox.textContent && successBox.innerText || dataSuccessMessage || !successStr || (successBox.innerHTML = successStr), "y" === form.getAttribute("data-success-popup") ? window.Form.showSuccessPopup(successBox.innerHTML) : successBox.style.display = "block"), t_addClass(form, "js-send-form-success"), successCallback && 0 === successCallback.indexOf("window.") && (successCallback = successCallback.split(".")[1]), successCallback && "function" == typeof window[successCallback] ? "undefined" != typeof jQuery ? eval(successCallback + "($(form))") : eval(successCallback + "(form)") : successUrl && setTimeout(function () {
      window.location.href = successUrl
   }, 500), window.Form.clearTCart(form);
   var upwidgetRemoveBtns = form.querySelectorAll(".t-upwidget-container__data_table_actions_remove svg"),
      ...
      inputPhone = form.querySelectorAll('input[type="tel"], input[type="hidden"][data--rule="phone"]'),
   ...
   Array.prototype.forEach.call(upwidgetRemoveBtns, function (t) {
      ...
      t.innerHTML = "", t.value = ""
   }), "undefined" != typeof jQuery && jQuery(form).data("formresult", {
      tranId: "0",
      orderId: "0"
   }), form.TranId = "0", form.OrderId = "0"
}, window.Form.clearTCart = function (t) {
...
}, window.Form.send = function (form, btnSubmit, formType, formKey) {
   form instanceof Element || (form = form[0]), btnSubmit instanceof Element || (btnSubmit = btnSubmit[0]);
   var allRecords = document.getElementById("allrecords"),
      pageId = allRecords.getAttribute("data--page-id"),
      projectId = allRecords.getAttribute("data--project-id"),
      formId = form.getAttribute("id"),
      dataFormCart = form.getAttribute("data-formcart");
   window.Form.payment = !1, "y" !== dataFormCart && !form.closest(".t706__orderform") || window.Form.addPaymentInfoToForm(form);
   try {
      window.mauser && window.Form.addMebersInfoToForm(form)
   } catch (error) {}
   ...
   if (inputItsGood || form.insertAdjacentHTML("beforeend", '<div style="position: absolute; left: -5000px; bottom: 0; display: none;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments" tabindex="-1" /></div>'), 2 === formType || !formType && formKey) {
      var Specs = {
         "spec-cookie": document.cookie,
         "spec-referer": window.location.href,
         "spec-formid": formId,
         "spec-formskey": formKey,
         "spec-version-lib": window.Form.versionLib,
         "spec-pageid": pageId,
         "spec-projectid": projectId,
         "spec-lang": window.t_forms__lang
      };
      for (spec in Specs) {
         var hiddenInput = form.querySelector('input[name="' + spec + '"]');
         hiddenInput || (form.insertAdjacentHTML("beforeend", '<input type="hidden" name="' + spec + '" value="">'), hiddenInput = form.querySelector('input[name="' + spec + '"]'), hiddenInput.value = Specs[spec])
      }
      try {
         hiddenInput = form.querySelector("input[name=spec-fp]"), hiddenInput || (form.insertAdjacentHTML("beforeend", '<input type="hidden" name="spec-fp" value="">'), hiddenInput = form.querySelector("input[name=spec-fp]")), window.stat ? hiddenInput.value = window.stat("fingerprint") : hiddenInput.value = "st" + window.pageYOffset + "w" + window.innerWidth + "h" + window.innerHeight + "ft" + form.getBoundingClientRect().top + window.pageYOffset
      } catch (error) {}
      inputItsGood = form.querySelector(".js-form-spec-comments"), inputItsGood && (inputItsGood.value = "");
      var formUrl = "https://" + window.Form.endpoint + "/procces/",
         dataForm = [],
         arrFilter = [];
      if (dataForm = t_serializeArray(form), Array.prototype.forEach.call(dataForm, function (t) {
            -1 === t.name.indexOf("delivery-") && arrFilter.push(t)
         }), dataForm = arrFilter, window.Form.payment && window.Form.payment.products) dataForm.push({
         name: "payment",
         value: JSON.stringify(window.Form.payment)
      });
      else if (form.closest(".t706__orderform")) return !1;
      window.Form.member && window.Form.member.code && dataForm.push({
         name: "member",
         value: JSON.stringify(window.Form.member)
      }), dataForm = t_forms__formData(dataForm);
      var startRequest = Date.now();
      t_triggerEvent(form, "form:beforesend");
            ...
            if (200 <= xhr.status && xhr.status < 400) {
               ...
               if (data) {
                  ...
                  if ("object" == typeof objData) {
                     ...
                     if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.SendingStatus = "0", objData && objData.error) {
                        ...
                        }), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "form:aftererror"), window.t_cart__discounts && window.localStorage.removeItem("tcart_discounts")
                     } else {
                        if (objData && objData.needcaptcha) return formKey ? void window.Form.addCaptcha(form, formKey) : void alert("Server busy. Please try again later.");
                        var formResult = {},
                           strValue, strValue;
                        objData && objData.results && objData.results[0] ? (strValue = objData.results[0], strValue = strValue.split(":"), formResult.tranId = strValue[0] + ":" + strValue[1], formResult.orderId = strValue[2] || "0", formResult.orderId && "0" !== formResult.orderId && (window.Form.orderIdForStat = formResult.orderId)) : (formResult.tranId = "0", formResult.orderId = "0"), "undefined" != typeof jQuery && jQuery(form).data("formresult", formResult), form.TranId = formResult.tranId, form.OrderId = formResult.orderId;
                        var dataEventName = form.getAttribute("data--event-name") || "",
                           dataEventName = dataEventName || ("y" === dataFormCart && objData && (objData.next && objData.next.type && ("function" !== objData.next.type || objData.next.value && ("stripev3" === objData.next.value.sysname || "outersite" === objData.next.value.installation)) || !objData.next) ? "//" + formId + "/payment/" : "//" + formId + "/submitted/"),
                           title = "Send data from form " + formId,
                           price = 0,
                           product = "",
                           priceEl = form.querySelector(".js--price");
                        if (window && "function" == typeof window.sendEventToStatistics) {
                           window.Form.payment && window.Form.payment.amount ? (price = window.Form.payment.amount, 0 < parseFloat(price) && (title = "Order " + formResult.orderId)) : priceEl && (price = priceEl.value, 0 < parseFloat(price) && (title = "Order " + formResult.orderId));
                           try {
                              window.sendEventToStatistics(dataEventName, title, product, price)
                           } catch (error) {
                        ...
                        try {
                           t_triggerEvent(form, "form:aftersuccess"), dataFormSendedCallback && "function" == typeof jQuery ? eval(dataFormSendedCallback + "($(form));") : dataFormSendedCallback && eval(dataFormSendedCallback + "(form);")
                        } catch (error) {
                           console.error("Error while call success callback. Code status: ", error)
                        }
                        if (objData && objData.next && objData.next.type) return window.Form.payment(form, objData.next), dataSuccessUrl = "", !1;
                        window.Form.successEnd(form, dataSuccessUrl, dataSuccessCallback)
                     }
                  }
               }
            } else {
               var tsDelta = Date.now() - startRequest;
               t_removeClass(btnSubmit), btnSubmit.SendingStatus = "0";
               var msgContainers = t_forms__getErrorContainers(form, ""),
                  errorBoxes = msgContainers.errorBoxes,
                  allError = msgContainers.allError;
               if (!xhr || 0 == xhr.status && tsDelta < 100) Array.prototype.forEach.call(allError, function (t) {
                  ...
                  if (xhr && (500 <= xhr.status || 408 == xhr.status || 410 == xhr.status || 429 == xhr.status || "timeout" == xhr.statusText) && -1 !== window.Form.endpoint.indexOf("forms.")) return window.Form.endpoint = "forms2.cdn.com", window.Form.send(form, btnSubmit, formType, formKey), !1;
               ...
               Array.prototype.forEach.call(allError, function (t) {
                  ...
                  t.style.display = "block"
               }), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "form:aftererror")
            }
      }, xhr.send(dataForm), !1
   }
   if ("y" !== form.getAttribute("data-is-formajax")) return -1 == form.getAttribute("action").indexOf(window.Form.endpoint) && (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.SendingStatus = "3", form.submit(), !0);
   var dataForm = {};
   dataForm = t_serializeArray(form), window.Form.payment && window.Form.payment.amount && dataForm.push({
      name: "payment",
      value: JSON.stringify(window.Form.payment)
   }), dataForm = t_forms__formData(dataForm);
   var xhr = new XMLHttpRequest;
   return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function () {
      if (4 === xhr.readyState)
         if (200 <= xhr.status && xhr.status < 400) {
            ...
            if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.SendingStatus = "0", l = xhr.responseText)
               if ("{" == l.substring(0, 1)) {
                  var o = JSON.parse(l);
                  if ("object" == typeof o)
                     ...
                     return Array.prototype.forEach.call(n, function (t) {
                        ...
                        t.style.display = "block"
                     }), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "form:aftererror"), !1
                  }
               } else t.innerHTML = l, t_parseScripts(t, "");
            var i = "//" + formId + "/submitted/",
               t = "Send data from form " + formId;
            window && "function" == typeof window.sendEventToStatistics ? window.sendEventToStatistics(i, t, "", 0) : "undefined" != typeof ga && "" !== window.mainTracker ? ga("send", {
               hitType: "pageview",
               page: i,
               title: t
               ...
               title: t,
               referer: window.location.href
            }), t_triggerEvent(form, "form:aftersuccess"), window.Form.successEnd(form, e, r)
         } else {
            t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.SendingStatus = "0";
   ...
   return window.Form.validate(t)
};
try {
   var PAGE_URL = window.location.href,
      PAGE_QUERY = "",
      PAGE_UTM = "";
   if (-1 !== PAGE_URL.toLowerCase().indexOf("utm_") && (PAGE_URL = PAGE_URL.toLowerCase(), PAGE_QUERY = PAGE_URL.split("?"), PAGE_QUERY = PAGE_QUERY[1], "string" == typeof PAGE_QUERY)) {
      var arPair, i, arParams = PAGE_QUERY.split("&"),
         date;
      for (i in arParams) "function" != typeof arParams[i] && (arPair = arParams[i].split("="), "utm_" == arPair[0].substring(0, 4) && (PAGE_UTM = PAGE_UTM + arParams[i] + "|||"));
      0 < PAGE_UTM.length && (date = new Date, date.setDate(date.getDate() + 30), document.cookie = "UTM=" + encodeURIComponent(PAGE_UTM) + "; path=/; expires=" + date.toUTCString())
   }
} catch (error) {}
   ...
   if (r) {
      ...
      if (o) {
         ...
         var a = o.getAttribute("id"),
            e = [],
            t = "";
         if (r.SendingStatus && (t = r.SendingStatus), !(t && 1 <= t || t_hasClass(r, "t706__submit_disable"))) {
            if (t_addClass(r, "t-btn_sending"), r.SendingStatus = "1", window.Form.hideErrors(o), e = window.Form.validate(o), window.Form.showErrors(o, e)) return t_removeClass(r, "t-btn_sending"), void(r.SendingStatus = "0");
            t = document.getElementById("allrecords").getAttribute("data--formskey"), e = parseInt(o.getAttribute("data-formactiontype"));
            if (!o.querySelectorAll(".js-formaction-services").length && 1 !== e && !t) {
               ...
               return Array.prototype.forEach.call(n, function (t) {
                  ...
                  t.style.display = "block"
               }), t_addClass(o, "js-send-form-error"), t_removeClass(r, "t-btn_sending"), r.SendingStatus = "0", void t_triggerEvent(o, "form:aftererror")
            }
            if (o.querySelector(".g-recaptcha") && grecaptcha) {
               window.Form.currentFormProccessing = {
                  form: o,
                  btn: r,
                  formtype: e,
                  formskey: t
               ...
               return n ? grecaptcha.reset(n) : (i = {
                  size: "invisible",
                  sitekey: o.getAttribute("data--captchakey"),
                  callback: window.Form.captchaCallback
               }, n = grecaptcha.render(a + "recaptcha", i), o.CaptchaClientId = n), void grecaptcha.execute(n)
            }
            window.Form.send(o, r, e, t)
         }
      }
   }
}
...
function t_forms__submitEvent(t) {
   var e, r = t;
   t.target && (r = t.target), r && (e = "", (r = r.querySelector('[type="submit"]')) && r.SendingStatus && (e = r.SendingStatus), e && "3" === e ? r.SendingStatus = "" : (r && !t_hasClass(r, "t706__submit_disable") && r.click(), t.preventDefault ? t.preventDefault() : t.returnValue = !1))
}

function t_asyncLoad(t) {
   var e = t.getAttribute("data--mask"),
      r = t.getAttribute("data--mask-holder"),
      o = t.getAttribute("data--mask-init");
   e && !o && (r ? t_onFuncLoad("t_customMask__mask", function () {
      ...
      t_customMask__mask(t, e)
   }), t.setAttribute("data--mask-init", "1"))
}
...
function t_forms__addRecaptcha() {
   var t = document.querySelectorAll(".js--captcha");
   Array.prototype.forEach.call(t, function (t) {
      var e, r, o, a = t.getAttribute("data--captchakey");
      a ? (e = t.getAttribute("id"), window.Form.isRecaptchaScriptInit || (r = document.head, o = document.createElement("script"), window.Form.isRecaptchaScriptInit = !0, o.type = "text/javascript", o.src = "https://www.google.com/recaptcha/api.js?render=explicit", o.async = !0, r.appendChild(o), r.insertAdjacentHTML("beforeend", '<style type="text/css">.js-send-form-success .grecaptcha-badge {display: none;}</style>')), document.getElementById(e + "recaptcha") || t.insertAdjacentHTML("beforeend", '<div id="' + e + 'recaptcha" class="g-recaptcha" data-sitekey="' + a + '" data-callback="window.Form.captchaCallback" data-size="invisible"></div>')) : t_removeClass(t, "js--captcha")
   })
}
...
function checkVerifyCaptcha(t) {
   if (-1 !== (t = t || window.event).origin.indexOf(window.Form.endpoint)) {
      var e = document.getElementById("js-spec-captcha"),
         r = document.getElementById("formcaptchabox");
...
function t_forms__onSuccess(t) {
   ...
   var c = "t" + r + "__inputsbox_hidden",
      ...
      p = document.querySelector(".t-label");
