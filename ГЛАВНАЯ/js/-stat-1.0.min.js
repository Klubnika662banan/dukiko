! function () {
   ...
   function a() {
      var e = window.pageYOffset,
         ...
         d = document.getElementById("copy"),
      ...
      if (!(c < 10))
         for (var l = [10, 25, 50, 75, 90], s = 0; s < l.length; s++) {
            var u = l[s],
               p = l.length - 1;
            if (0 === s && u <= c && !w["p" + u]) g.page = "//scroll/" + u + "/", window.stat("pageview"), w["p" + u] = !0;
            else if (u - 1 <= c) {
               if (0 === w["p" + u]) {
                  g.page = "//scroll/" + u + "/", window.stat("pageview"), w["p" + u] = setTimeout(function () {
   ...
   function l() {
      v = n("uid"), y = n("sid"), y = f ? (v = v || "simple", y || "simple") : (v = v || e(), y || e())
   }
   ...
   function u() {
      if (!("" < g.user_agent && -1 != g.user_agent.indexOf("bot")))
         if ("http:" != window.location.protocol && "https:" != window.location.protocol) console.log("Stat: cannot work on local page");
         else {
            var t;
            l(), s(), g.page = d(), g.referrer = document.referrer || "", g.userid = v, g.sessionid = y, g.user_agent = window.navigator.userAgent, g.user_language = window.navigator.userLanguage || window.navigator.language, r && (g.projectid = r.getAttribute("data--project-id") || "0", g.pageid = r.getAttribute("data--page-id") || "0", g.pagealias = r.getAttribute("data--page-alias") || "", g.formskey = r.getAttribute("data--formskey") || ""), g.params = {};
            try {
            ...
            var n = !1;
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (n = !0), g.ismobile = n, document.getElementById("statscript") && (g.statcode = document.getElementById("statscript").key), h) try {
               var e = function (e) {
                     m = !!e
                  },
                  o = !0;
   ...
   function p() {
      f || (n("sid") || "") != g.sessionid && o("sid", g.sessionid, {
         expires: 1800,
         path: "/"
      }), "" === g.referrer && (g.referrer = n("previousUrl") || ""), g.utm = n("UTM") || "", g.page || (console.log("Stat: page empty"), g.page = d(), window.location.hash && 0 === window.location.hash.indexOf("#!") && (g.page += window.location.hash)), "/" === g.page.substring(0, 1) && (g.page = window.location.hostname + g.page);
      var e = function (e) {
            var t, n = "";
            for (t in e)
      ...
      t.open("POST", "https://stat.cdn.com/event/", !0), t.withCredentials = !1, t.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), t.onerror = function (e) {
         console.error("Stat: fail pageview "), console.error(e)
      }, t.timeout = 3e3, t.send(e), g.page && -1 === g.page.indexOf("/scroll") && -1 === g.page.indexOf("/readtime") && -1 === g.page.indexOf("/click") && -1 === g.page.indexOf("/cookieenabled") && (g.referrer = g.page, f || o("previousUrl", g.page, {
         path: "/",
         expires: 1800
      })), g.page = "", window.statload = !0
   }
   window.stat = function (e, t) {
      if (!e) return !1;
      ...
      switch (e) {
         ...
         case "pageview":
            ...
            break;
         case "readtime":
            h && (m && (g.page = "//readtime/", m = !1, p()), setTimeout(function () {
               window.stat("readtime")
            }, 15e3));
            break;
         case "scroll":
            ...
            break;
         case "cookieenabled":
            f = !1, l(), s(), g.userid = v, g.sessionid = y, g.page = "//cookieenabled/", p();
            break;
         case "fingerprint":
            return c()
      }
   ...
   var g = {},
      ...
      m = !0,
      f = "no" === window.statcookie,
      h = (window.statcookie || r && (f = "no" === r.getAttribute("data--cookie")), "yes" === window.statcookiegdpr && !1 === f && (f = !0) === n("t_cookiesConsentGiven") && "string" == typeof (i = n("t_cookiesCategories")) && -1 < i.indexOf("analytics") && (f = !1), "yes" === window.statscroll),
      v = (void 0 === window.statscroll && r && (h = "yes" === r.getAttribute("data--stat-scroll")), ""),
      y = "",
      b = !1,
      t = (window.stat("create"), setTimeout(function () {
         window.stat("pageview"), window.stat("readtime"), window.stat("scroll")
      }, 500), setInterval(function () {
         var e;
         ("object" == typeof window.t_jserrors && 0 < window.t_jserrors.length || "object" == typeof window.t_cdnerrors && 0 < window.t_cdnerrors.length || "object" == typeof window.t_ajaxerrors && 0 < window.t_ajaxerrors.length) && "function" != typeof t_errors__sendJSErrors && ((e = document.createElement("script")).src = "https://static.cdn.com/js/-errors-1.0.min.js", e.async = !0, document.body.appendChild(e), clearInterval(t))
      }, 2e3)),
      i = document.querySelector("link[rel*='shortcut icon']"),
      k = (k = document.querySelectorAll("link[href*='.ws/project']").length) || document.querySelectorAll("link[href*='ws.cdn.com/project']").length,
      x = i ? i.getAttribute("href") : "",
      E = document.querySelector("script[src*='js/-scripts']"),
      E = !!E && -1 === E.src.indexOf("cdn");
   E = E || i && -1 !== x.indexOf("static.cdn.com") && -1 !== x.indexOf(".") && -1 !== x.indexOf("/favicon.ico") && !document.querySelector("table#allrecords") && !(-1 !== window.location.hostname.indexOf("..ws")) && !k, void 0 === navigator.sendBeacon || /Bot/i.test(navigator.userAgent) || E || 1 === Math.floor(5 * Math.random()) && (i = function () {
      var e = document.createElement("script");
      e.async = !0, e.type = "text/javascript", e.src = "https://static.cdn.com/js/-performance-1.0.min.js", document.body.insertAdjacentElement("beforeend", e)
