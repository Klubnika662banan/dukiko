...
function cover_init(e) {
   var t = document.getElementById("allrecords"),
      t = !!t && "yes" === t.getAttribute("data--lazy"),
      o = document.getElementById("rec" + e),
      r = document.getElementById("coverCarry" + e),
      o = o ? o.querySelector("img[data-hook-clogo]") : null;
   if (r) {
      var n, i = {
         "cover-bg": "",
         "cover-height": "",
      ...
      for (n in i) {
         var c = r.getAttribute("data-content-" + n);
         c && (i[n] = c)
      }
      var a = ["mp4", "webm", "youtube"],
         a = ("yes" === i["video-nocover"] ? a.forEach(function (e) {
            i["video-url-" + e] = ""
         }) : i["video-nomute"] = "", a.some(function (e) {
            return !!i["video-url-" + e]
         }));
      (window.t_cover__isMobile || "ontouchend" in document) && a && !t && (r.style.backgroundImage = 'url("' + i["cover-bg"] + '")'), setTimeout(function () {
         t_cover__recalcContentHeight(e, !1, 0), t_cover__fixBgFixedNode(e)
      }, 300), o && (o.onload = function () {
      ...
      }), t_cover__setListenerToArrow(e), t_cover__setCoverParams(r, i, a), r.addEventListener("displayChanged", function () {
         t_cover__recalcContentHeight(e, !1, 0)
      })
   }
}
...
function t_cover__setCoverParams(e, t, o) {
   var r, n, i = "fixed" === t["cover-parallax"],
      c = "dynamic" === t["cover-parallax"],
      a = "yes" === t["bg-base64"];
   t_cover__setCoverVideoParams(e, t, o, i), i && window.isOpera && (e.style.transform = "unset"), c && !window.t_cover__isMobile && ((i = t_cover__getPureHeight(e)) < window.innerHeight && (c = .2 * window.innerHeight, e.style.height = i + c + "px"), t_cover__parallax(e)), a && t["cover-bg"] && !o && (r = !1, (n = document.createElement("img")).src = t["cover-bg"], n.onload = function () {
      n.parentElement && n.parentElement.removeChild(n), e.style.backgroundImage = 'url("' + t["cover-bg"] + '")', e.style.opacity = "1", r = !0
   }, r || (e.style.backgroundImage = "", e.style.opacity = "0", e.style.transition = "opacity 25ms"))
}
...
function t_cover__setStylesForCoverVideo(e, t) {
   e.style.backgroundColor = "#000000", e.style.backgroundImage = "youtube" === t ? "" : 'url("https://.ws/img/spinner-white.gif")', e.setAttribute("data-content-cover-bg", "")
}
...
function t_cover__initCovers() {
   ...
   !!e && "edit" === e.getAttribute("data--mode") || (e = document.querySelectorAll(".t-cover__carrier"), Array.prototype.forEach.call(e, function (e) {
      ...
      e.forEach(function (e) {
         Math.floor(e.getBoundingClientRect().right) > t && (e.style.wordBreak = "break-all")
      })
   }))
}
...
function t_cover__createHTMLVideoCover(e, t, o, r, n, i) {
   var c, a, d, _;
   e.querySelector("video") || (c = window.pageYOffset, a = window.innerHeight, d = t_cover__getPureHeight(e), (_ = e.getBoundingClientRect().top + c) - 500 < c + a && c <= d + _ + 500 && t_cover__createAndProcessHTML5Video(e, t, n, i))
}
...
function t_cover__recalcCoverHeight(e, t) {
   var o, r, n, i, c, a, d, _ = document.getElementById("rec" + e);
   _ && (e = _.querySelector(".t-cover"), o = "935" === _.getAttribute("data-record-type"), e && !o && (o = _.querySelector(".t-cover__carrier"), r = o ? o.getAttribute("data-content-cover-height") : "", n = "y" === _.getAttribute("data-fixed-bg"), (i = [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper"]).forEach(function (e) {
      var e = _.querySelector(e),
         t = t_cover__getHeightFromAttr(r);
      e && t && (e.style.height = Math.round(t) + "px")
   }), c = t_cover__getHeightFromAttr(r), d = t_cover__getPureHeight(e), c = c || d, n || (a = e.style.height, e.style.height = "", c = d, a && (e.style.height = a)), d = t_cover__getPureHeight(_.querySelector("div[data-hook-content]")), e = !!o && "100vh" === o.getAttribute("data-content-cover-height"), 300 < d && c < d + 40 || n || (window.t_cover__isMobile || "ontouchend" in document) && t ? (t_cover__setRecalculatedHeight(_, d), t_cover__updateResizeElem(_)) : window.t_cover__isMobile && e && i.forEach(function (e) {
      e = _.querySelector(e);
...
function t_cover__setRecalculatedHeight(t, e) {
   var o = t.querySelector(".t-cover__carrier"),
      r = t_cover__getHeightFromAttr(o ? o.getAttribute("data-content-cover-height") : "0"),
      n = o ? "dynamic" === o.getAttribute("data-content-cover-parallax") : "",
      i = window.innerWidth <= 568 ? 40 : 120,
      c = window.innerWidth <= 568 ? 50 : 100,
      a = (1e3 < (e += i) && (e += c), r < e ? e : r),
      d = 0,
      i = ([".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper", ".t-cover__container"].forEach(function (e) {
         e = t.querySelector(e);
         n && e && e.classList.contains("t-cover__carrier") && a < document.documentElement.clientHeight ? (d = .2 * document.documentElement.clientHeight, e.style.height = a + d + "px") : e && (e.style.height = a + "px")
      }), o.setAttribute("data-content-cover-updated-height", a + d + "px"), document.createEvent("Event"));
   i.initEvent("coverHeightUpdated", !0, !0), o.dispatchEvent(i)
}

function t_cover__updateResizeElem(e) {
   var t, o = document.getElementById("allrecords");
   !o || "yes" !== o.getAttribute("data--lazy") || (t = e.querySelector(".t-cover__carrier"), t_onFuncLoad("t_lazyload_updateResize_elem", function () {
